...
messages = {
    'en': {
        'welcome': "🌆 Welcome to Siistibot! Help map where your city needs improvement for better outdoor living. This bot lets you:\n - Mark spots that feel uncomfortable (noise, smell, pollution)\n - Suggest what would make public spaces more enjoyable\n - Build a collective map highlighting areas that need attention\n Your input helps others avoid problematic areas while showing the city where improvements matter most. What's affecting your comfort outdoors today? 📍\n\n ⚠️This bot is intended only for persons aged 18 and older. In case you expect someone's health to be endangered or observe severe pollution in natural waters or on the ground, immediately contact 112!",
        ...
        'issue_list_prompt': "What's making this spot uncomfortable right now?",
        'issue_list': [
            "Smoke from fire or burning",
            "Excessive noise (construction, etc.)",
        ...
        'improvement_list_prompt': "What would make this spot more comfortable?",
        'improvement_list': [
        ...
        'labels': {
            ...
            'time_in_turku': 'Time living in the city'
        },
        ...
        'time_in_turku_question': "How long have you lived in this city?",
        'time_in_turku_options': [
            "Less than 1 year", "1-3 years", "3-10 years", "10-20 years", "My whole life", "I don't live here", "Prefer not to disclose"
        ]
    },
    'fi': {
        'welcome': "🌆 Tervetuloa Siistibottiin! Auta kartoittamaan, missä kaupunkisi kaipaa parannuksia paremman ulkoilun mahdollistamiseksi. Tämän botin avulla voit:\n - Merkitä paikat, jotka tuntuvat epämiellyttäviltä (melu, haju, saasteet)\n - Ehdottaa, mikä tekisi julkisista tiloista miellyttävämpiä\n - Rakentaa kollektiivisen kartan, jossa korostetaan alueita, jotka tarvitsevat huomiota\n Sinun panoksesi auttaa muita välttämään ongelmallisia alueita ja näyttää samalla kaupungille, missä parannuksilla on eniten merkitystä. Mikä vaikuttaa viihtyvyyteesi ulkona tänään? 📍\n\n\n ⚠️This bot on tarkoitettu vain 18 vuotta täyttäneille henkilöille. Jos oletat jonkun terveyden vaarantuvan tai havaitset vakavaa saastumista luonnonvesissä tai maastossa, ota välittömästi yhteyttä 112!",
        ...
        'issue_list_prompt': "Mikä tekee tästä paikasta epämukavan juuri nyt?",
        'issue_list': [
            "Savuhaitta, palaminen",
            "Liiallinen melu (esim. rakennustyöt)",
        ...
        'improvement_list_prompt': "Mikä tekisi tästä paikasta mukavamman?",
        'improvement_list': [
        ...
        'labels': {
            ...
            'gender': 'Sukupuoli',
            'occupation': 'Ammatti',
            'time_in_turku': 'Asuinaika tässä kaupungissa'
        },
        ...
        'time_in_turku_options': [
            "Alle vuoden", "1-3 vuotta", "3-10 vuotta", "10-20 vuotta", "Koko elämäni", "En asu tässä kaupungissa", "En halua kertoa"
        ]
    },
    'sv': {
        'welcome': "🌆 Välkommen till Siistibot! Hjälp till att kartlägga var din stad kan förbättras för bättre utomhusmiljö. Med den här botten kan du:\n - Markera platser som känns obehagliga (buller, lukt, föroreningar)\n - Föreslå förbättringar för mer trivsamma offentliga platser\n - Skapa en gemensam karta över områden som behöver åtgärdas\nDina tips hjälper andra att undvika problemområden och visar staden vilka förbättringar som behövs mest. Vad påverkar din utevistelse idag? 📍\n\n⚠️ Denna bot är endast avsedd för personer som är 18 år eller äldre. Om du misstänker att någons hälsa är i fara eller observerar allvarliga föroreningar i vattnet eller på marken, kontakta genast 112!",
        ...
        'issue_list_prompt': "Vad gör denna plats obekväm just nu?",
        'issue_list': [
            "Rökskada, förbränning",
            "Högt buller (t.ex. byggarbete)",
        ...
        'improvement_list_prompt': "Vad skulle göra denna plats mer bekväm?",
        'improvement_list': [
        ...
        'labels': {
            ...
            'time_in_turku': 'Tid boende i staden'
        },
        ...
        'time_in_turku_options': [
            "Mindre än 1 år", "1-3 år", "3-10 år", "10-20 år", "Hela mitt liv", "Jag bor inte här", "Föredrar att inte svara"
        ]
    },
    'uk': {
        'welcome': "🌆 Вітаємо у Siistibot!\n\nДопоможіть створити карту місць, які потребують покращення для комфортного проведення часу на відкритому повітрі.\n\nЦей бот дозволяє вам:\n- Відмічати місця, де некомфортно (шум, сморід, забруднення)\n- Пропонувати, як зробити громадські простори більш приємними\n- Створювати колективну карту, що висвітлює проблемні зони\n\nВаш внесок допомагає іншим уникати проблемних місць і показує місту, де покращення найбільш необхідні. \n\nЩо впливає на ваш комфорт надворі сьогодні? 📍 \n\n⚠️ Тільки для повнолітніх! Якщо ви підозрюєте, що комусь загрожує небезпека для здоров'я або спостерігаєте серйозне забруднення природних вод чи ґрунтів — негайно зверніться за номером 112!",
        ...
        'issue_list': [
            ...
            "Турбуючий шум (будівництво тощо)",
        ...
        'labels': {
            ...
            'time_in_turku': 'Час проживання в місті'
        },
        ...
        'time_in_turku_options': [
            "Менше року", "1-3 роки", "3-10 років", "10-20 років", "Все життя", "Я не живу в цьому місті", "Надаю перевагу не вказувати"
        ]
    }
}
...
# Ensure the ask_language_selection function is working correctly
...
# Update the time in city question function
...
# Update the time in city keyboard function
